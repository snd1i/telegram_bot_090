# extensions/admin.py - PROFESYONEL DUYURU SİSTEMİ (DÜZELTİLDİ)
...
class BroadcastSession:
    def __init__(self, user_id):
        ...
        self.buttons = []
        self.state = None
        self.temp_button_text = None  # Buton metni için geçici saklama
...
def setup(app):
    ...
    # Mesajlar - FİLTRELERİ DÜZELTTİM (ÇAKIŞMA YOK)
